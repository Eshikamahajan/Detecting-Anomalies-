...
#creating training and test splits from the data divided above
...
# for complete explanation of the early stopping method visit my repo NER :https://github.com/Eshikamahajan/NamedEntityRecognition
...
#from the above plots, it is observed that most of the data lies below 0.65 thus chosing 0.65 as our threshold
#any data above 0.65 will be treated as an outlier or an anomaly
THRESHOLD = 0.65
...
#plotting the data along with the decided threshold to find the anomalies
fig = go.Figure()
...
#Plotting close price with highlighted anomalies
fig = go.Figure()
